 ...
 *
 * The Prune hooks (30 distinct scripts, 32 event bindings — loop-breaker and
...
export const HOOK_REGISTRY = [
  ...
  { file: "tool-call-coalescing.mjs", event: "PreToolUse" },
  { file: "billing-tier-drift.mjs", event: "Stop" },
